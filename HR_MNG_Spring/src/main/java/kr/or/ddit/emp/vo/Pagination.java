...
public class Pagination<T> {
	...
	private Map<String, Object> variousCondition = new HashMap<>(); 
	...
	public void addSearchCondtion(String conditionName, Object searchValue) {
		variousCondition.put(conditionName, searchValue);
	}
}
