...
public class ImageFormServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		html.append("<select name='image' onchage='this.form.submit()'>");
		html.append("			</select>                             ");
		html.append("			<button type='submit'>전송</buttom>    ");
		html.append("		</form>                                   ");
		html.append("	</body>                                       ");
		html.append("</html>                                          ");
...
/*
 * PrintWriter out = null; // 1.7 미만의 형태 try { out = resp.getWriter();
 * out.println(html); } finally { if (out != null) out.close(); }
 * 
 * } }
 */
