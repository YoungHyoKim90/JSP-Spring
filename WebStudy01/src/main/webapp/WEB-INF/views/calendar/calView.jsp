...
%>
<h4>
   <a href="javascript:;" class="changer" data-year="<%=beforeYM.getYear() %>" data-month="<%=beforeYM.getMonthValue() %>">전 달</a>
   
   [ <%=targetYM.format(DateTimeFormatter.ofPattern("uuuu, MMMM", locale)) %> ]
   
   <a href="javascript:;" class="changer" data-year="<%=nextYM.getYear() %>" data-month="<%=nextYM.getMonthValue() %>">다음 달</a>
   </h4>
